...
import objetoDAO.PrepareTransaccionDAO;
...
public class iPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Cliente Existente");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jButtonNuevoCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        //Como habiamos comentado en clase la transaccion sucede al reiniciar la base de datos, pero no 
        // realizo esta funcionalidad ya que no tiene ningun sentido dejo este oton desahibilitado 
        //para que veas que esta , existe pero no esta habilitado
        
        PrepareTransaccionDAO miTrasaccion = new PrepareTransaccionDAO();
        miTrasaccion.reiniciarBBDD(new PreparaTransaccion("src//sql//taller_coche.sql").getMiLista());
